<#
.SYNOPSIS
    Syncs the TSPAllEmployees AD group — Toyota Spare Parts division.
...
.PARAMETER Diagnose      Report TSP dept users NOT in AllEKKEmployees.
#>
param(
    [switch]$Test,
    [switch]$Auto,
...
$Departments = @(
    "Accounts - TOSP"
    "Administration and Support - TOSP"
    "Bulk Sales - TOSP"
    "Inventory - TOSP"
    "Sales - TOSP"
    "Toyota Spare Parts"
...
Write-Log "================================================================" "HEADER"
Write-Log "  TSPAllEmployees Group Sync  —  $(Get-Date -Format 'dd-MMM-yyyy HH:mm')" "HEADER"
