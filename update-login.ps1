  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .bg-fallback{
      position:fixed;
      inset:0;
      background:linear-gradient(135deg,#0b2f54 0%,#1a4a7a 50%,#0f3a68 100%);
      z-index:-1;
    }
    .overlay{
      position:fixed;
    ...
    .flash-success{
      background:#e8f7ee;color:#116b39;
      border:1px solid #cdecd8;
      border-radius:8px;padding:8px 12px;
      margin-bottom:12px;font-size:12px;font-weight:600;text-align:left;
    }
    .flash-error{
      background:#fdeceb;color:#a12622;
